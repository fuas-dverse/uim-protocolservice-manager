"""
Pydantic models for chatbot messages.
...
class ChatbotQuery(BaseModel):
    ...
    Published to: uim.chatbot.query (NATS) or POST /chat (HTTP)
    """
...
class ChatbotResponse(BaseModel):
    ...
    Published to: uim.chatbot.response (NATS) or returned from POST /chat (HTTP)
    """
    ...
    services_discovered: List[str] = Field(
        ...
        description="Names of services discovered via AQS"
    )
